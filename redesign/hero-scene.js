...
function init(host) {
  ...
  const palette = ['#6650A8', '#5AC8FA', '#B9A2FF', '#E4622F', '#6FE0C8', '#FF8FB0']
  ...
  const mat = new THREE.ShaderMaterial({
    ...
    uniforms: {
      ...
      uColA: { value: new THREE.Color('#6650A8') },   // violet (brand)
      uColB: { value: new THREE.Color('#5AC8FA') },   // sky cyan -- lifts the mood
      uColC: { value: new THREE.Color('#C9A8FF') },   // pale lilac highlight
      uLime: { value: new THREE.Color('#E4622F') },   // energy green
      uAccent: { value: new THREE.Color('#6650A8') }, // lerped per form, see palette[] in loop
      uPull: { value: 0 },
